                                ...
                                <form class="login-form"  onsubmit="return continueOrNot()">
                                    <!--form-group  -->
                                      ...
                                      <!-- sign-in-btn-box -->
                                        ...
                                        <p  class="sign-btn">No account yet? <a href="register.php" class="page-link">Register</a></p>
                                        </div>
                                        <!-- sign-in-btn-box -->
                                      <!-- btn-box -->
                                        <div class="btn-box">
                                          <button type="submit" class="btn-login" id="login" name="submit">sign in</button>
                                        </div>
                                        <!-- btn-box -->
